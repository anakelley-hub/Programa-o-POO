public class MainHeranca {
    ...
    public static void main(String[] args) {
        ...
        Carro carroSUV = new Carro(4, "SUV", "Honda", "HR-V", 2025, 160000.0);
        Carro carroSedan = new Carro(4, "Sedan", "toyota", "Corola", 2024, 150000.00);
        Carro carroHatch = new Carro(4, "Hatch", "Chevrolet", "Onix", 2023, 85000.0);
        Carro carroCupe = new Carro(4, "Cupe", "Porche", "911 Carrera", 2026, 900000.0);
