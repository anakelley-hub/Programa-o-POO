public class Main {
    public static void main(String [] args) {
        ...
        //1. Instanciando objetos ( criando instancias na memória)
        ...
        System.out.println("--- Testando interaçoes com o Civic ---");
        carro2.desligarMotor(); // tentando desligar o motor ja desligado
        carro2.ligarMotor();
